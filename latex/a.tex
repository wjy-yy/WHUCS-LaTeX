...
\setCJKfamilyfont{song}[AutoFakeBold={4}]{SimSun}
...
\begin{document}
	...
	\vspace{50pt}
	{\song\zihao{1}\bfseries 武汉大学计算机学院\\\vspace{10pt}
		本科生课程设计报告}
...
\subsection{自定义字体}
	...
	\begin{itemize}
		\item {\tt$\backslash$zihao{1}} {\zihao{1} 一号}
		\item {\tt$\backslash$zihao{-1}} {\zihao{-1} 小一}
		\item {\tt$\backslash$zihao{2}} {\zihao{2} 二号}
		\item {\tt$\backslash$zihao{-2}} {\zihao{-2} 小二}
		\item {\tt$\backslash$zihao{3}} {\zihao{3} 三号}
		\item {\tt$\backslash$zihao{-3}} {\zihao{-3} 小三}
		\item {\tt$\backslash$zihao{4}} {\zihao{4} 四号}
		\item {\tt$\backslash$zihao{-4}} {\zihao{-4} 小四}
		\item {\tt$\backslash$zihao{5}} {\zihao{5} 五号}
		\item {\tt$\backslash$zihao{-5}} {\zihao{-5} 小五}
	\end{itemize}
